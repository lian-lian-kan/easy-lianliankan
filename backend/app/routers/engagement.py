...
@router.post("/achievements/{achievement_id}",
             dependencies=[Depends(rate_limit("achievement", limit=3000, window_seconds=60)),
                          Depends(user_rate_limit("achievement", limit=60, window_seconds=60))])
...
@router.put("/missions",
            dependencies=[Depends(rate_limit("missions_put", limit=3000, window_seconds=60)),
                          Depends(user_rate_limit("missions_put", limit=60, window_seconds=60))])
...
@router.post("/wallet/entries",
             dependencies=[Depends(rate_limit("wallet", limit=1500, window_seconds=60)),
                          Depends(user_rate_limit("wallet", limit=30, window_seconds=60))])
...
@router.post("/signin",
             dependencies=[Depends(rate_limit("signin", limit=300, window_seconds=60)),
                          Depends(user_rate_limit("signin", limit=10, window_seconds=60))])
