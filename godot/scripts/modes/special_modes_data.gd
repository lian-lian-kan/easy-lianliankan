...
const DEFAULT_CONFIGS = {
	...
	"boss": {
		"mode_id": "boss",
		"name": "Boss挑战",
		"description": "每消一对打 Boss 一下，先打败它",
		"unlock_level": 15,
		"boss_hp": 24,
		"defense_start": 5,
		"defense_step": 12,
...
const MODES = {
	...
	"boss": {"icon": "👾", "label": "Boss挑战", "blurb": "消除打Boss，别让它近身", "intro": "Boss挑战！👾 每消一对就打 Boss 一下，先打败它，别让它近身", "cat": "mech", "settle": "战胜Boss", "sub": "best"},
	"sum10": {"icon": "🔟", "label": "合十消", "blurb": "两数相加为10即可消", "intro": "合十消！🔟 两张牌的数字相加为 10 就能消除", "cat": "mech", "settle": "合十满分", "sub": "best"},
	"diff1": {"icon": "🎱", "label": "差一消", "blurb": "两数相差1即可消", "intro": "差一消！🎱 两张牌的数字相差 1 就能消除", "cat": "mech", "settle": "差一通关", "sub": "best"},
	"mult": {"icon": "🎲", "label": "倍数消", "blurb": "两数成倍即可消", "intro": "倍数消！🎲 两张牌的数字成倍就能消除", "cat": "mech", "settle": "倍数通关", "sub": "best"},
